    ...
    <div className={classes.root}>
      ...
      >
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={6}><JsonPanel completeAppJson={props.completeAppJson} entities={props.dataForTable} dropDownEntitieGetter={props.dropDownEntitieGetter} selectedEntitieDropDown={props.selectedEntitieDropDown} selectedJsonEntite={props.selectedJsonEntite} onEditInJsonView={props.onEditInJsonView}/></Grid>
