...
class Main extends Component{
    state = {
      ...
      selectedEntitieDropDown:undefined,
      selectedJsonEntite:{},
      EnvTree:undefined,
    ...
    render(){
      return (
        <React.Fragment>
          ...
          dropDownEntitieGetter={this.onEntiteDropDownSelect}
          openDialog={this.openDialog}
          onCommit={this.onCommit}
          onDiscard={this.onDiscard}
          onEditInJsonView={this.onEditInJsonView}
          selectedEnv={this.state.selectedEnv}
          EnvTree={this.state.EnvTree}
          appsToDisplay={this.state.appsToDisplay}
          selectedApp={this.state.selectedApp}
          selectedEntitieDropDown={this.state.selectedEntitieDropDown}
          selectedJsonEntite={this.state.selectedJsonEntite}
  ...
  getUniqueKeys(json , stack , path , index){
    ...
    onEntiteDropDownSelect = (e) => {
      let entiteName = e.target.value
      let entiteObj = this.state.dataForTable[entiteName]
      this.setState({selectedEntitieDropDown : entiteName , selectedJsonEntite : entiteObj})
    }
    onEditInJsonView = (json) => {
      console.log(json)
      this.setState({selectedJsonEntite:json})
    }
}
