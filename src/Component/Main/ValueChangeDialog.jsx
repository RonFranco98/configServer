    ...
    return (
      ...
      >
        ...
        <DialogContent>
          ...
          <DialogContentText>Environment: {tableEnv}</DialogContentText>
        ...
        <DialogActions>
          ...
          <Button onClick={() => this.props.commitDialog(tableEnv, app, this.state.newValue , path)} className={this.props.classes.commitButton} variant="contained" autoFocus>
            commit
          </Button>
        </DialogActions>
      </Dialog>
